  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        ...
        <button
          type="submit"
          className="w-full mt-2 py-3 rounded-lg bg-linear-to-r from-indigo-500 via-purple-600 to-indigo-500 text-white font-medium hover:brightness-110 transition-all duration-300 shadow-lg shadow-indigo-900/30"
        >
          Send Message
        </button>
